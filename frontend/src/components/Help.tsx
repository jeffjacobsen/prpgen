    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">PRPGen Help</h2>
              ...
              <div className="space-y-3 text-gray-700 dark:text-gray-300">
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    ...
                    <li>PRPGen runs Claude Code with <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">--dangerously-ignore-permissions</code></li>
                  </ul>
                </div>
                  ...
                  <ol className="list-decimal list-inside space-y-2">
                    <li><strong>Create or select a project:</strong>
                      <ul className="list-disc list-inside ml-4 mt-1 text-sm">
                        <li>Point to a new directory - PRPGen will create it and initialize git</li>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-600 dark:text-gray-400">
          PRPGen - Product Requirement Prompt & Template Manager
        </div>
      </div>
    </div>
  );
