# Contributing to PRPGen

Thank you for your interest in contributing to PRPGen! We welcome contributions from the community and are excited to work with you.

PRPGen is an open source project created by [Stravu](https://stravu.com/).  Stravu is the way AI-first teams collaborate.
...
### Current Status
PRPGen doesn't have automated tests yet - we welcome contributions to add them! If you'd like to help set up a testing framework, please open an issue to discuss the approach.
...
Thank you for contributing to PRPGen! 🎉
